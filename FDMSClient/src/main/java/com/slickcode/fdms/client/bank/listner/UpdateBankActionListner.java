...
public class UpdateBankActionListner extends FdmsActionListner {
	private BasePanel basePanel;
	private BankVO bankVO;
	private IBankService bankService;
	
	public UpdateBankActionListner(BasePanel basePanel) {
	...
	public boolean performAction(ActionEvent e) {
		if (basePanel.validatePanelData()) {
			...
			BankResult result = bankService.update(bankPanelBean.getBankVO());

			if (result.isSuccess()) {
				showPopUp("Bank Updated Successfully", "Message");
