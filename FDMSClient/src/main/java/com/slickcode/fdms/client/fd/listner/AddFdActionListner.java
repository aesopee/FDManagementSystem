...
public class AddFdActionListner extends FdmsActionListner {

	private BasePanel basePanel;
	private FdVO fdVO;
	private IFdService fdService;

	public AddFdActionListner(BasePanel basePanel) {
	...
	public boolean performAction(ActionEvent e) {
		if (basePanel.validatePanelData()) {
			...
			FdResult result = fdService.create(fdPanelBean.getFdVO());
			if (result.isSuccess()) {
