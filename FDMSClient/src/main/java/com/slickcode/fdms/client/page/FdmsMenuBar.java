...
import com.slickcode.fdms.client.constants.MenuConstants;
...
public class FdmsMenuBar extends JMenuBar {
	...
	private void populateFileMenu() {
		JMenu fileMenu = MenuUtils.populateJMenu(MenuConstants.MENU_FILE, KeyEvent.VK_F);

		JMenuItem exit = MenuUtils.populateJMenuItem(MenuConstants.MENU_EXIT, null, KeyEvent.VK_E, KeyEvent.VK_E);
	...
	private void populateBankMenu() {
		JMenu menu = MenuUtils.populateJMenu(MenuConstants.MENU_BANK_HOME, KeyEvent.VK_B);

		JMenuItem add = MenuUtils.populateJMenuItem(MenuConstants.MENU_ADD, null, KeyEvent.VK_B, KeyEvent.VK_A);
		add.addActionListener(new InitiateAddBankActionListner());
		menu.add(add);

		JMenuItem search = MenuUtils.populateJMenuItem(MenuConstants.MENU_SEARCH, null, null, KeyEvent.VK_S);
		search.addActionListener(new InitiateSearchBankActionListner());
		menu.add(search);

		JMenuItem showAll = MenuUtils.populateJMenuItem(MenuConstants.MENU_SHOW_ALL, null, null, KeyEvent.VK_O);
	...
	private void populatePersonMenu() {
		JMenu menu = MenuUtils.populateJMenu(MenuConstants.MENU_PERSON_HOME, KeyEvent.VK_P);

		JMenuItem add = MenuUtils.populateJMenuItem(MenuConstants.MENU_ADD, null, KeyEvent.VK_P, KeyEvent.VK_A);
	...
	private void populateFDMenu() {
		JMenu menu = MenuUtils.populateJMenu(MenuConstants.MENU_FD_HOME, KeyEvent.VK_D);

		JMenuItem add = MenuUtils.populateJMenuItem(MenuConstants.MENU_ADD, null, KeyEvent.VK_N, KeyEvent.VK_A);
		add.addActionListener(new InitiateAddFdActionListner());
		menu.add(add);

		JMenuItem search = MenuUtils.populateJMenuItem(MenuConstants.MENU_SEARCH, null, KeyEvent.VK_F, KeyEvent.VK_S);
		search.addActionListener(new InitiateSearchFdActionListner());
		menu.add(search);

		JMenuItem showAll = MenuUtils.populateJMenuItem(MenuConstants.MENU_SHOW_ALL, null, KeyEvent.VK_A,
				KeyEvent.VK_O);
		showAll.addActionListener(new InitiateShowAllFdActionListner());
		menu.add(showAll);

		JMenuItem maturedFds = MenuUtils.populateJMenuItem(MenuConstants.MENU_MATURED_FDS, null, KeyEvent.VK_M,
				KeyEvent.VK_M);
		maturedFds.addActionListener(new InitiateMaturedFDsActionListner());
		menu.add(maturedFds);

		JMenuItem fdsInNextWeek = MenuUtils.populateJMenuItem(MenuConstants.MENU_FDS_IN_NEXT_WEEK, null, KeyEvent.VK_W,
				KeyEvent.VK_W);
	...
	private void populateHelpMenu() {
		JMenu help = MenuUtils.populateJMenu(MenuConstants.MENU_HELP, KeyEvent.VK_H);

		JMenuItem about = MenuUtils.populateJMenuItem(MenuConstants.MENU_ABOUT, null, null, KeyEvent.VK_A);
	...
	private void populateUserDetails(PersonVO personVO) {
		...
		JMenuItem logout = MenuUtils.populateJMenuItem(MenuConstants.MENU_LOGOUT, null, KeyEvent.VK_L, KeyEvent.VK_L);
